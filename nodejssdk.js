...
//bootstrapOauthFromSelfClient(); // run first for tokens just once --> env $(cat .env | xargs) node nodejssdk.js
testSDK(); // and then run tihs function for test --> env $(cat .env | xargs) node nodejssdk.js